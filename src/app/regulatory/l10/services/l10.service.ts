...
import { 
  L10BrechasSensibilidad, 
  L10ReportRequest, 
  L10ReportResponse, 
  L10Summary, 
  L10ValidationResult 
} from '../models/l10.model';
...
export class L10Service {
  ...
  // Validar datos L10
  validateL10Data(data: L10BrechasSensibilidad[]): Observable<L10ValidationResult> {
    return this.http.post<L10ValidationResult>(`${this.regulatoryUrl}/l10/validate`, data)
      .pipe(
        catchError(() => {
  ...
  // Obtener resumen L10
  getL10Summary(): Observable<L10Summary> {
    return this.http.get<L10Summary>(`${this.adapterUrl}/l10/summary`)
      .pipe(
        catchError(() => {
