...
export class L14Service {
  ...
  // Validar datos L14
  validateL14Data(data: L14ConcentracionDepositos[]): Observable<any> {
    return this.http.post(`${this.regulatoryUrl}/l14/validate`, data)
      .pipe(
        catchError(() => {
  ...
  // Obtener resumen L14
  getL14Summary(): Observable<any> {
    return this.http.get(`${this.adapterUrl}/l14/summary`)
      .pipe(
        catchError(() => {
