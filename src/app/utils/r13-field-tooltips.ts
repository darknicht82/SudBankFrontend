...
export interface R13FieldTooltip {
  no: number;
  campo: string;
  tipoDeDato: string;
...
export const R13_FIELD_TOOLTIPS: R13FieldTooltip[] = [
  {
    "no": 1,
 ...
 */
export const R13_STRUCTURE_INFO = {
 ...
 */
export function getR04FieldTooltip(fieldName: string): R13FieldTooltip | null {
  return R13_FIELD_TOOLTIPS.find(tooltip => tooltip.campo === fieldName) || null;
}

/**
 * Obtener todos los tooltips de R04
 */
export function getAllR04FieldTooltips(): R13FieldTooltip[] {
  return R13_FIELD_TOOLTIPS;
}
