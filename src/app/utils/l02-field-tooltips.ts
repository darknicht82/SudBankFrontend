/**
 * TOOLTIPS Y GLOSARIO DE CAMPOS L02
 * Manual Técnico Control de Inversiones v3.0 - Marzo 2017
 * Superintendencia de Bancos del Ecuador
 */

// export interface L02FieldTooltip {
//   field: string;
//   title: string;
//   description: string;
//   source: string;
...
export const L02_FIELD_TOOLTIPS: L02FieldTooltip[] = [
  {
    "no": 1,
...
/**
 * Obtener tooltip para un campo específico de L02
 */
export function getL02FieldTooltip(fieldName: string): L02FieldTooltip | null {
  // return L02_FIELD_TOOLTIPS.find(tooltip => tooltip.field === fieldName) || null;
  return L02_FIELD_TOOLTIPS.find(tooltip => tooltip.campo === fieldName) || null;
}

/**
 * Obtener todos los tooltips de L02
 */
export function getAllL02FieldTooltips(): L02FieldTooltip[] {
  return L02_FIELD_TOOLTIPS;
}

/**
 * Información estructural de L02
 */
export const L02_STRUCTURE_INFO = {
  title: 'Estructura L02 - Emisores, Custodios y Contrapartes',
  ...
  fileFormat: 'L02E1038ddmmaaaa.txt',
  requirements: {
      "table": "L02 - Saldo y Liquidaciones de inversiones",
      "requisites": {
        "scope": [
        ...
        "repurchaseAfterLiquidation": [
          ...
          "Usar campo 'fecha de compra' en L02 para diferenciar recompra de liquidación anterior"
        ],
        "fieldRules": [
...
/**
 * Validaciones específicas para campos L02
 */
export const L02_FIELD_VALIDATIONS = {
  tipoIdentificacion: {
    required: true,
    pattern: /^[RX]$/,
