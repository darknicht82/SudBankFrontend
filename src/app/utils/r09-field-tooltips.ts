/**
 * TOOLTIPS Y GLOSARIO DE CAMPOS R09
 * Manual Técnico Control de Inversiones v3.0 - Marzo 2017
 * Superintendencia de Bancos del Ecuador
 */

// export interface R09FieldTooltip {
//   field: string;
//   title: string;
//   description: string;
//   source: string;
...
export const R09_FIELD_TOOLTIPS: R09FieldTooltip[] = [
  {
    "no": 1,
...
/**
 * Obtener tooltip para un campo específico de R09
 */
export function getR09FieldTooltip(fieldName: string): R09FieldTooltip | null {
  // return R09_FIELD_TOOLTIPS.find(tooltip => tooltip.field === fieldName) || null;
  return R09_FIELD_TOOLTIPS.find(tooltip => tooltip.campo === fieldName) || null;
}

/**
 * Obtener todos los tooltips de R09
 */
export function getAllR09FieldTooltips(): R09FieldTooltip[] {
  return R09_FIELD_TOOLTIPS;
}

/**
 * Información estructural de R09
 */
export const R09_STRUCTURE_INFO = {
  title: 'Estructura R09 - Emisores, Custodios y Contrapartes',
  ...
  fileFormat: 'R09E1038ddmmaaaa.txt',
  requirements: {
      "table": "R09 - Saldo y Liquidaciones de inversiones",
      "requisites": {
        "scope": [
        ...
        "preconditions": [
          "El título debe haber sido reportado previamente en R09 en el mismo mes o en meses anteriores"
        ],
        ...
        "liquidationsAndSales": {
          ...
          "partialSale": [
            ...
            "No es necesario volverlo a reportar en R09"
          ]
        },
        "exclusions": [
        ...
        "repurchaseAfterLiquidation": [
          "Si se recompra un título liquidado con 'LI', reportar en R09 con mismo número de título y fecha de emisión pero nueva fecha de compra",
          "Usar campo 'fecha de compra' en R09 para diferenciar recompra de liquidación anterior"
        ],
        "fieldRules": [
...
/**
 * Validaciones específicas para campos R09
 */
export const R09_FIELD_VALIDATIONS = {
  tipoIdentificacion: {
    required: true,
    pattern: /^[RX]$/,
