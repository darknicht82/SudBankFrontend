 ...
 * Superintendencia de Bancos del Ecuador - Versión 12.0 - 27/09/2023
 */

export interface R12FieldTooltip {
  no: number;
  campo: string;
  tipoDeDato: string;
...
export const R12_FIELD_TOOLTIPS: R12FieldTooltip[] = [
  {
    "no": 1,
    "campo": "Tipo de identificación del inegrante",
    "tipoDeDato": "Caracter (1)",
    "obligatoriedad": "X",
    "tabla": "4",
    "descripcion": "Se refiere al tipo de documento de identificación del integrante de la entidad miembro del grupo económico, puede ser “C”, “R” o “E”."
  },
  {
    "no": 2,
    "campo": "Nombre del grupo economico",
    "tipoDeDato": "Caracter (80)",
    "obligatoriedad": "X",
    "tabla": "",
    "descripcion": "Representa el nombre que la institución financiera ha asignado al grupo económico."
  },
  {
    "no": 3,
    "campo": "Identificacion integrante",
    "tipoDeDato": "Caracter (13)",
    "obligatoriedad": "X",
    "tabla": "",
    "descripcion": "Corresponde al número de identificación de la entidad miembro del grupo económico. Para personas naturales ecuatorianas será el número de cédula, para personas jurídicas el número de RUC y para personas extranjeras el código de extranjero asignado por la Superintendencia de Bancos."
  },
 ...
 */
export const R12_STRUCTURE_INFO = {
  ...
  source: 'Manual Técnico de Estructuras de Datos de Operaciones Activas y Contingentes - Versión 12.0 - 27/09/2023',
 ...
 */
export function getR04FieldTooltip(fieldName: string): R12FieldTooltip | null {
  return R12_FIELD_TOOLTIPS.find(tooltip => tooltip.campo === fieldName) || null;
}

/**
 * Obtener todos los tooltips de R04
 */
export function getAllR04FieldTooltips(): R12FieldTooltip[] {
  return R12_FIELD_TOOLTIPS;
}
