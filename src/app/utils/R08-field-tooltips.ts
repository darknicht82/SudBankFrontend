/**
 * TOOLTIPS Y GLOSARIO DE CAMPOS R08
 * Manual Técnico Control de Inversiones v3.0 - Marzo 2017
 * Superintendencia de Bancos del Ecuador
 */

// export interface R08FieldTooltip {
//   field: string;
//   title: string;
//   description: string;
//   source: string;
...
export const R08_FIELD_TOOLTIPS: R08FieldTooltip[] = [
  {
    "no": 1,
...
/**
 * Obtener tooltip para un campo específico de R08
 */
export function getR08FieldTooltip(fieldName: string): R08FieldTooltip | null {
  // return R08_FIELD_TOOLTIPS.find(tooltip => tooltip.field === fieldName) || null;
  return R08_FIELD_TOOLTIPS.find(tooltip => tooltip.campo === fieldName) || null;
}

/**
 * Obtener todos los tooltips de R08
 */
export function getAllR08FieldTooltips(): R08FieldTooltip[] {
  return R08_FIELD_TOOLTIPS;
}

/**
 * Información estructural de R08
 */
export const R08_STRUCTURE_INFO = {
  title: 'Estructura R08 - Emisores, Custodios y Contrapartes',
  ...
  fileFormat: 'R08E1038ddmmaaaa.txt',
  requirements: {
      "table": "R08 - Saldo y Liquidaciones de inversiones",
      "requisites": {
        "scope": [
        ...
        "preconditions": [
          "El título debe haber sido reportado previamente en R08 en el mismo mes o en meses anteriores"
        ],
        ...
        "liquidationsAndSales": {
          ...
          "partialSale": [
            ...
            "No es necesario volverlo a reportar en R08"
          ]
        },
        "exclusions": [
        ...
        "repurchaseAfterLiquidation": [
          "Si se recompra un título liquidado con 'LI', reportar en R08 con mismo número de título y fecha de emisión pero nueva fecha de compra",
          "Usar campo 'fecha de compra' en R08 para diferenciar recompra de liquidación anterior"
        ],
        "fieldRules": [
...
/**
 * Validaciones específicas para campos R08
 */
export const R08_FIELD_VALIDATIONS = {
  tipoIdentificacion: {
    required: true,
    pattern: /^[RX]$/,
