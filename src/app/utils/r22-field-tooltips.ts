...
export interface R22FieldTooltip {
  no: number;
  campo: string;
  tipoDeDato: string;
...
export const R22_FIELD_TOOLTIPS: R22FieldTooltip[] = [
  {
    "no": 1,
  ...
  {
    "no": 4,
    "campo": "Dias de morosidad",
    "tipoDeDato": "Numerico (5)",
    "obligatoriedad": "X",
    "tabla": "",
    "descripcion": "Indica el número real de días que el saldo de la tarjeta de crédito se encuentra vencida (número de días impagos a partir de la última cuota pagada). Información será verificada por el organismo de control. Si la tarjeta no se encuentra en mora se colocará 0 (cero), caso contrario los días quecorresponda."
  },
  {
    "no": 5,
    ...
    "obligatoriedad": "X",
    "tabla": "29",
    "descripcion": "Es la calificación correspondiente a la categoría de riesgo, asignada de acuerdo a los parámetros establecidos para calificación de activos de riesgo."
  },
  {
    "no": 6,
  ...
  },
  {
    ...
    "obligatoriedad": "X",
    "tabla": "",
    "descripcion": "Valor que de acuerdo a las disposiciones normativas requiere provisionar como mínimo, según la calificación asignada."
  },
  {
    "no": 8,
    "campo": "Provision constituida",
    "tipoDeDato": "Numérico (15,2)",
    "obligatoriedad": "X",
    "tabla": "",
    "descripcion": "Valor de la reserva real constituida de acuerdo al riesgo calificado."
  },
  {
    "no": 9,
    "campo": "Valor minimo a pagar",
    "tipoDeDato": "Numérico (15,2)",
    "obligatoriedad": "X",
    "tabla": "",
    "descripcion": "Es el monto que se registra en el estado de cuenta del tarjetahabiente, como valor mínimo a pagar en el mes del reporte."
  },
  {
    "no": 10,
    "campo": "Valor pagado",
    ...
    "obligatoriedad": "X",
    "tabla": "",
    "descripcion": "Es el monto que el tarjetahabiente canceló en el mes de reporte a la institución financiera de su tarjeta de crédito."
  },
  {
    "no": 11,
    "campo": "Valor a pagar",
    ...
    "obligatoriedad": "X",
    "tabla": "",
    "descripcion": "Es el monto que se registra en el estado de cuenta del tarjetahabiente, como valor a pagar en el mes del reporte. Para efectos de reporte consignar únicamente el valor del capital."
  },
  {
    "no": 12,
    "campo": "Valor del intereses del valor a pagar",
    "tipoDeDato": "Numérico (15,2)",
    "obligatoriedad": "X*",
    "tabla": "",
    "descripcion": "Es el monto de interés que corresponde del valor a pagar, en el caso que genere intereses por consumos. Para efectos de reporte consignar únicamente el valor del interés generado en el mes de reporte."
  },
  {
    "no": 13,
    "campo": "Valor del seguro del valor a pagar",
    "tipoDeDato": "Numérico (15,2)",
    "obligatoriedad": "X*",
    "tabla": "",
    "descripcion": "Es el monto que se registra en el estado de cuenta del tarjetahabiente. Para efectos de reporte consignar únicamente el valor del seguro contratado."
  },
  {
    "no": 14,
    ...
    "obligatoriedad": "X",
    "tabla": "",
    "descripcion": "Es el valor de las cuotas que el cliente ha dejado de cancelar al acogerse al beneficio de diferimiento (COVID-19) a la fecha de corte. Podrá venir sin información cuando su “Estado de la Operación” sea diferente de COE."
  },
  {
    "no": 15,
    ...
    "obligatoriedad": "X",
    "tabla": "",
    "descripcion":"Es el valor del interés de las cuotas que el cliente ha dejado de cancelar al acogerse al beneficio de diferimiento (COVID-19) a la fecha de corte. Podrá venir sin información cuando su “Estado de la Operación” sea diferente de COE."
  }
];
 ...
 */
export const R22_STRUCTURE_INFO = {
 ...
 */
export function getR04FieldTooltip(fieldName: string): R22FieldTooltip | null {
  return R22_FIELD_TOOLTIPS.find(tooltip => tooltip.campo === fieldName) || null;
}

/**
 * Obtener todos los tooltips de R04
 */
export function getAllR04FieldTooltips(): R22FieldTooltip[] {
  return R22_FIELD_TOOLTIPS;
}
